    ...
    <AuditDialogProvider bookingUrl={getBookingUrl()}>
      ...
      <main id="main" className="flex-1 pt-12 pb-20 sm:pt-16 sm:pb-24">
        <Container className="max-w-3xl">
          <p className="label-mono text-muted-foreground">Last updated {updated}</p>
          ...
          <div className="mt-12 rounded-lg border border-border bg-muted/50 p-5 text-[0.8125rem] leading-relaxed text-muted-foreground">
            <p>
              <strong className="font-medium text-foreground">Placeholder notice.</strong> This
              page is a working draft written to be readable, not a substitute for legal advice.
              {" "}
              {brand.name} should have it reviewed by a qualified lawyer before running paid
              traffic at scale or handling customer data on behalf of partners.
            </p>
          </div>
        </Container>
      </main>
